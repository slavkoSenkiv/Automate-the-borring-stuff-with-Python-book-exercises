...
string, like grid (list below)

Think of grid[x][y] as being the character at the x- and y-coordinates
of a “picture” drawn with text characters. The (0, 0) origin is in the upperleft corner, the x-coordinates
...
up to grid[8][0]. This will finish the first row, so then print a newline. Then your program should print
